...
import 'package:eos_plugin_android/eos_wallet.dart';
import 'package:flutter/services.dart';

class EosPluginAndroid {
  /// 通道名称
  static const MethodChannel _channel = const MethodChannel('com.rapaq.eos_plugin_android');
